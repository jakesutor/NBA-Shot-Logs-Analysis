...
res = r.get('http://stats.nba.com/stats/leaguedashplayerstats', params=req_params, headers=headers)
res.raise_for_status()
...
# to see the top few results and output
shots_df.head()

# identifying specific team for the clippers
clippers_id = 1610612746

shots_df.loc[shots_df['TEAM_ID'] == clippers_id]
